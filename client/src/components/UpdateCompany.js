...
const EDIT_COMPANY_QUERY = gql`
    mutation EditCompanyQuery($id: Int!, $name: String, $address: String, $city: String, $zip_code: Int, $description: String) {
        editCompany(ID: $id, NAME: $name, ADDRESS: $address, CITY: $city, ZIP_CODE: $zip_code, DESCRIPTION: $description) {
            ID
            NAME
            ADDRESS
            CITY
